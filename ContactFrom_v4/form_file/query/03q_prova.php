        ...
        echo '<div class="card purple">';
            echo '<div class="additional">';
                echo '<div class="user-card">';
                    ...
                    if (isset($_SESSION["username"])){
                      echo '<a style="color: white;" href="..\..\manageDatabase.php"'.'<h4>'.'PRENOTA'.'</h4>'.'</a>';
                    }else{
                      echo '<a style="color: white;" href="..\..\account.php"'.'<h6>'.'accedi e prenota'.'</h6>'.'</a>';
                    }
          ...
          echo '<span class="more">Scorri il mouse sulla card per più info</span>';
          echo '</div>';
          echo '</div>';
