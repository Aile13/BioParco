...
<body>
	...
	<div class="container-contact100" style="padding-left: 230px;">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="form_file/query/04q_criterio_ora.php" method="POST">
				<span class="contact100-form-title">
					ricerca Animali
				</span>

				<div class="wrap-input100 input100-select">
					<span class="label-input100">Inserisci NOME SCIENTIFICO e SESSO dell'animale che vuoi visualizzare</span>
					<div>
				...
				<div class="wrap-input100 validate-input">
					<span class="label-input100">inserisci nome scientifico</span>
					<input class="input100" type="text" name="criterio1" placeholder="esempio: --> Giraffa camelopardalis">
					<span class="focus-input100"></span>
				</div>	
