		        ...
		        <form class="form-register" action="#" method="post">
		        	<div id="form-total">
			            ...
			            <section>
			                <div class="inner">
								...
								<div class="form-row">
									...
									<div class="form-holder">
										<fieldset>
											<legend>Paese di origine</legend>
											<input type="text" class="form-control" id="last-name" name="last-name" placeholder="example: Portugal" required>
										</fieldset>
									</div>
								</div>
								<div class="form-row">
									<div class="form-holder">
										<fieldset>
											<legend>Lingua Madre</legend>
											<input type="text" class="form-control" id="first-name" name="first-name" placeholder="example: portoghese" required>
										</fieldset>
									</div>									
								</div>
							</div>
			            ...
			            <h2>
			            	...
			            	<span class="step-text">Personal description</span>
			            </h2>
			            <section>
			                <div class="inner">
			                	<div class="wizard-header">
								...
								<div class="form-row">
									<div class="form-holder">
										<fieldset>
											<legend>Numero di telefono</legend>
											<input type="text" class="form-control" id="first-name" name="first-name" placeholder="example: 3775894578" required>
										</fieldset>
									</div>									
								</div>																		
								...
								<div class="form-row">
									<div class="form-holder form-holder-2">
										<input type="text" class="form-control input-border" id="ssn" name="ssn" placeholder="Descrizione.. es: mi chiamo * nella vita mi piace ** etc" required>
									</div>
								</div>
							</div>
			            </section>
