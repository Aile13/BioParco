	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('login_file/images/bg-01.jpg'); padding-left: 230px;">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form action="http://localhost/carpooling/20_02_2020/ContactFrom_v4/account_file/account_login.php" >
					...
					<span class="login100-form-title p-b-49">
						...
						<div class="txt1 text-center p-t-54 p-b-20">
							<span>
								Accedi ad un account già esistente
							</span>
						</div>	
				...
				<form action="http://localhost/carpooling/20_02_2020/ContactFrom_v4/account_file/scegli_crea_account.php" >
                    ...
                    <div class="container-login100-form-btn">
						...
						<a href="../login_file\php\logout.php" class="txt1 p-t-44 p-b-20">
						clicca per uscire da tutti gli account	<!-- 1 --> 
						</a>																																			
					</div>
