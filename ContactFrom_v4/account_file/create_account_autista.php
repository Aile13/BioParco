    ...
    <body>
        ...
        <div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
            <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
                ...
                <a href="manageDatabase.php" class="w3-bar-item w3-button" style="width:25% !important">crea Account</a>
            </div>
        </div>
        <!----------------------------------------------------------------------------------------------------------->
                ...
                <div class="wizard-form">
                    <form class="form-register" action="#" method="post">
                        <div id="form-total">
                            ...
                            <section>
                                <div class="inner">
                                    <div class="wizard-header">
                                        ...
                                        <p>Completa i campi richiesti e procedi a compilare gli step successivi, così che potremo inserire nel programma l'animale.</p>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-holder">
                                            <fieldset>
                                                <legend>Nome Scientifico</legend>
			            	...
			            	<span class="step-text">Park Infomation</span>
			            </h2>
                            <section>
                                <div class="inner">
                                    <div class="wizard-header">
                                    ...
                                    <div class="form-row">
                                        <div class="form-holder">
                                            <fieldset>
                                                <legend>Nome</legend>
                                                <input type="text" class="form-control" id="first-name" name="first-name" placeholder="ex: zona 1, zona 8" required>
                                            </fieldset>
                                        </div>
			            	...
			            	<span class="step-text">Extra Infomation</span>
			            </h2>
                            <section>
                                <div class="inner">
                                    <div class="wizard-header">
                                    ...
                                    <div class="form-row">
                                        <div class="form-holder form-holder-2">
                                            <input type="text" class="form-control input-border" id="ssn" name="ssn" placeholder="Info origine.. es: Brasile * foresta.. ** etc" required>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-holder form-holder-2">
                                            <input type="text" class="form-control input-border" id="ssn" name="ssn" placeholder="Caratteri distintivi.. es: cicatrice * braccio dx ** etc" required>
                                        </div>
                                    </div>
                                </div>
                            </section>
