...
<body>
	...
	<div class="container-contact100" style="padding-left: 230px;">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="form_file/query/03q_prova.php" method="POST">
				<span class="contact100-form-title">
					ricerca Animali
				</span>

				<div class="wrap-input100 input100-select">
					<span class="label-input100">default "QUALSIASI VIAGGIO" *soste e *tempo_percorrenza vengono cercati viaggi con un numero di soste/tempo minore di quelle/o inserito </span>
					<div>
						<select class="selection-2" name="criterio_select">
							<option>Seleziona Criterio</option>
							<option>città partenza</option>
							<option>città destinazione</option>
                            <option>numero soste</option>
                            <option>tempo percorrenza</option>
						</select>
					</div>
				...
				<div class="wrap-input100 validate-input">
					<span class="label-input100">inserisci criterio scelto</span>
					<input class="input100" type="text" name="criterio1" placeholder="esempio: --> numero soste: 6">
					<span class="focus-input100"></span>
				</div>	
				
				<!-- input date di partenza da ricercare-->
				<div class="wrap-input100 validate-input">
					<span class="label-input100">data partenza (obbligatorio)</span>
					<input class="input100" type="date" name="data_partenza" placeholder="inserisci data partenza" required>					
					<span class="focus-input100"></span>
				</div>
...
<!--===============================================================================================-->
	<script src="form_file/vendor/jquery/jquery-3.2.1.min.js"></script>
<!--===============================================================================================-->
	<script src="form_file/vendor/animsition/js/animsition.min.js"></script>
<!--===============================================================================================-->
	<script src="form_file/vendor/bootstrap/js/popper.js"></script>
	<script src="form_file/vendor/bootstrap/js/bootstrap.min.js"></script>
<!--===============================================================================================-->
	<script src="form_file/vendor/select2/select2.min.js"></script>
	<script>
		$(".selection-2").select2({
