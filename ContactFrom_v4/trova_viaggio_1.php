...
<body>
	...
	<div class="container-contact100" style="padding-left: 230px;">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action="form_file/query/01q_citta_data_ora.php" method="POST">
				...
				<div class="wrap-input100 validate-input">
					<span class="label-input100">nome scientifico</span>
					<input class="input100" type="text" name="citta_partenza" placeholder="inserisci città di partenza" required>
