...
<body>
  ...
  ?>  																	
    ...
    <?php
        ...
        $atopic = new TopicData(); // creo un oggetto $topic che permette di effettuare la connesione al db
        $aresponse = $atopic->getCittaAllDataOra($citta_partenza, $citta_destinazione, $data_partenza, $ora_partenza);   
        //all'oggetto $topic chiamo il metopo occorrente, mi viene restituita una risposta (query corrente)                         
    foreach($aresponse as $ares){  
        echo '<div class="card green">'
            echo '<div class="additional">'
                echo '<div class="user-card">'
          echo $res['id_viaggio'];          
          echo $res['citta_partenza'];
          echo $res['citta_destinazione'];
          echo $res['data_partenza'];
          echo $res['ora_partenza'];
          echo $res['tempo_percorrenza_stimato'];
          echo $res['numero_soste'];
          echo $res['possibilita_bagaglio'];
          echo $res['possibilita_animali'];          
    }
      ...
      <div class="additional">
        <div class="user-card">
          ...
          <div class="points center">
            ...
            <img style="border-radius: 50%;" src="\img\f4.jpg" width="110" height="110" class="center">
        </div>
        <div class="more-info">
          <h1>Jane Doe</h1>
          <div class="coords">
        ...
        <div class="additional">
          <div class="user-card">
            ...
            <div class="points center">
              ...
              <img style="border-radius: 50%;" src="\img\f5.jpg" width="110" height="110" class="center">
          </div>
          <div class="more-info">
            <h1>Jane Doe</h1>
            <div class="coords">
